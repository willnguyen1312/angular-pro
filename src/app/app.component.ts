...
export class AppComponent implements AfterViewInit {
  ...
  ngAfterViewInit(): void {
    if (this.imageWheelContainerRef) {
      ...
      this.zoomImageWheelService.zoomImageState$.subscribe((state: any) => {
  ...
  async handleTabClick(tab: Tab) {
    ...
    const handlers: Record<ZoomType, () => void> = {
      ...
      hover: () => {
        ...
        this.zoomImageHoverService.zoomImageState$.subscribe((state: any) => {
      ...
      move: () => {
        ...
        this.zoomImageMoveService.zoomImageState$.subscribe((state: any) => {
      ...
      click: () => {
        ...
        this.zoomImageClickService.zoomImageState$.subscribe((state: any) => {
